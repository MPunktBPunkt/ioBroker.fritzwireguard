...
class FritzWireguardLogic {
    ...
    _version() { try { return require('../package.json').version; } catch (_) { return '0.2.19'; } }
...
function runReady(adapter)       { return _logic.onReady.call(adapter); }
function runUnload(adapter, cb)  { return _logic.onUnload.call(adapter, cb); }
function runStateChange(a, id, s){ return _logic.onStateChange.call(a, id, s); }
function runMessage(adapter, obj){ return _logic.onMessage.call(adapter, obj); }
