...
'.btn-sm{display:inline-block;padding:4px 10px;font-size:0.75rem;border-radius:6px;text-decoration:none;vertical-align:middle;margin-left:8px;white-space:nowrap;}' +
'a.tunnel-link{color:var(--accent);text-decoration:none;border-bottom:1px dotted rgba(0,229,255,.4);}' +
...
'        +esc(t.lanIp+":"+t.localPort)+"</a> <span style=\'color:var(--muted);font-size:0.75rem\'>(LAN)</span>"' +
'        +"<a class=\'btn btn-sm\' href=\'"+esc(openUrl)+"\' target=\'_blank\' rel=\'noopener\'>\u00d6ffnen</a>";' +
'    }else{' +
