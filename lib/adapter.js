...
'      +"<td class=\'mono\' data-label=\'Lokal\' title=\'127.0.0.1:"+esc(t.localPort)+"\'>127.0.0.1:"+esc(t.localPort)+"</td>"' +
...
'Jeder Tunnel \u00f6ffnet einen Port auf <code>127.0.0.1</code> und leitet Verbindungen durch WireGuard weiter.<br>' +
'Andere Adapter: Feld <b>IP/Host</b> = <code>127.0.0.1</code>, Feld <b>Port</b> = lokaler Tunnel-Port (getrennt!).<br>' +
'Nicht <code>127.0.0.1:8085</code> in ein einziges Feld schreiben \u2014 das schl\u00e4gt DNS fehl.<br>' +
'Der restliche Netzwerkverkehr bleibt lokal (kein Full-Tunnel).<br><br>' +
'<strong>Beispiel Kostal Piko:</strong> Ziel <code>192.168.178.30:80</code> &rarr; Tunnel-Port <code>8085</code> &rarr; ' +
'Kostal: IP <code>127.0.0.1</code>, Port <code>8085</code>.' +
'</div>' +
