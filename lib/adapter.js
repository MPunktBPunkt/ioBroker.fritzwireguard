...
'    var localLabel=t.exposeLan' +
'      ?(t.lanIp?t.lanIp+":"+t.localPort:"0.0.0.0:"+t.localPort)+" (LAN)"' +
'      :"127.0.0.1:"+t.localPort;' +
'    var localTitle=t.exposeLan' +
'      ?"Auch vom Handy/PC: http://"+(t.lanIp||"<Host-IP>")+":"+t.localPort+"/"' +
'      :"Nur lokal f\u00fcr Adapter auf diesem Host";' +
'    tb+="<tr><td data-label=\'Name\' title=\'"+esc(t.name)+"\'><strong>"+esc(t.name)+"</strong></td>"' +
'      +"<td class=\'mono\' data-label=\'Lokal\' title=\'"+esc(localTitle)+"\'>"+esc(localLabel)+"</td>"' +
